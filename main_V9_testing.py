            ...
            for row in registration_problem:
                ...
                if algorithm_type == "LOCAL":
                    ...
                    if algorithm == "FGR":
                        ...
                        # Get Registration Solution
                        solution, alg_time = execute_RANSAC_global_registration(src_pcd_transformed, tgt_pcd, voxel_size)
                        # solution, alg_time = execute_RANSAC_global_registration(src_pcd_transformed, tgt_pcd, voxel_size, performLocalRefinement)
                        T_source2target = solution.transformation
                        T_target2source = np.linalg.inv(solution.transformation)
...
if __name__ == '__main__':
    ...
    # algorithm = local_registration_algs[1]
    algorithm = global_registration_algs[3]
